...
<head>
    ...
    <title>Detail - AMRBHTR Portfolio</title>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 portfolio-info">
                        ...
                        <ul>
                            <li><strong>Nama</strong>: Website Sekolah</li>
                            <li><strong>Client</strong>: SMPN 4 Pamarican</li>
                            <li><strong>Tanggal dibuat</strong>: 03 Agustus, 2020</li>
                            <li><strong>Project URL</strong>: <a href="#">www.smpnegeri4pamarican.sch.id</a></li>
                        </ul>
